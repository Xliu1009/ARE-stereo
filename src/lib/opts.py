...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--nms', type=float, default=-1.0,
                             help='run nms in testing.')
    self.parser.add_argument('--nms_2d', action='store_true',
                             help='run nms in testing.')
    self.parser.add_argument('--aug_max', action='store_true',
                             help='run nms in testing.')
  ...
  def parse(self, args=''):
    ...
    opt.demo_results_dir = os.path.join(opt.exp_dir, 'demo', opt.exp_id)
