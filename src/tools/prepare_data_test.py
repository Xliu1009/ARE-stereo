...
if __name__ == '__main__':
    img2_path='/root/autodl-tmp/kitti/testing/image_2/'
    img3_path = '/root/autodl-tmp/kitti/testing/image_3/'
    calib_path = '/root/autodl-tmp/kitti/testing/calib/'
    outp='/root/autodl-tmp/kitti/kitti_format_test/'
    ...
    for idx in images:
        ...
        idx_tar="{:06d}".format( int(float(idx[:6])+7518) )+'.png'
    ...
    for idx in calibes:
        img_name = os.path.join(calib_path, idx)
        idx_tar = "{:06d}".format( int(float(idx[:6])+7518) ) + '.txt'
